...
#define dyn_system_hco(input, state, dstate, output)                                                                                                                            \
	{                                                                                                                                                                           \
		double gfm = -2.0;                                                                                                                                                      \
		double gsp = 6.0;                                                                                                                                                       \
		double gsm = -4.0;                                                                                                                                                      \
...
#define hco_system_record(count)                                           \
	{                                                                      \
...
#define hco_setup(nb_state, nb_input, nb_output, input, state, state2, dstate, dstate2, output) \
	{                                                                                           \
		nb_state = 12;                                                                          \
		nb_input = 5;                                                                           \
		nb_output = 1;                                                                          \
		...
		input[2] = -2.5; /* Iapp */                                                             \
                                                                                                \
		input[3] = 10000.0; /* gsyn */                                                           \
		input[4] = 0.0;	   /* dsyn */                                                           \
	}

#define hco_sim_com(input, output) \
	{                              \
		lock.lock();               \
                                   \
		input[0] = feed2_com;      \
...
#define hco_sim_record(input, state, dstate, output, count)                                   \
	{                                                                                         \
		int offset = NB_CHANNEL_SYSTEM * count;                                               \
                                                                                              \
		lock.lock();                                                                          \
		system_data[offset] = ((double)Brain.Timer.systemHighResolution()) * 1e-6; /* Time */ \
		system_data[offset + 1] = output[0];									   /* Out1 */ \
		system_data[offset + 2] = output[1];									   /* Out2 */ \
		system_data[offset + 3] = input[0];										   /* In1 */  \
